	...
	A3(
		...
		A3(
			...
			A3(
				...
				'id',
				$elm$json$Json$Decode$string,
				$elm$json$Json$Decode$succeed($author$project$Tournament$Tournament)))));
var $author$project$Tournament$tournamentsResponseDecoder = A2(
	$elm$json$Json$Decode$field,
	'tournaments',
...
var $author$project$NewTournament$initialModel = function (navKey) {
	return {
...
var $author$project$Standings$StandingsReceived = function (a) {
	return {$: 'StandingsReceived', a: a};
};
var $author$project$SingleStanding$Standing = F7(
	function (playerName, points, wins, games, spread, tournamentsPlayed, rank) {
		return {games: games, playerName: playerName, points: points, rank: rank, spread: spread, tournamentsPlayed: tournamentsPlayed, wins: wins};
	});
var $elm$json$Json$Decode$float = _Json_decodeFloat;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$SingleStanding$standingDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'rank',
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'player_name',
							$elm$json$Json$Decode$string,
							$elm$json$Json$Decode$succeed($author$project$SingleStanding$Standing))))))));
var $author$project$SingleStanding$standingsResponseDecoder = A2(
	$elm$json$Json$Decode$field,
	'standings',
	...
	var _v1 = function () {
		...
		switch (_v2.$) {
			...
			case 'Tournaments':
				...
				var pageCmds = _v3.b;
				return _Utils_Tuple2(
					$author$project$Main$TournamentListPage(pageModel),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$ListPageMsg, pageCmds));
			case 'Standings':
				var _v4 = $author$project$Standings$init;
				var pageModel = _v4.a;
				var pageCmds = _v4.b;
				return _Utils_Tuple2(
...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Route$Tournaments, $elm$url$Url$Parser$top),
			A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$Standings,
			$elm$url$Url$Parser$s('standings')),
			A2(
			$elm$url$Url$Parser$map,
			...
			case 'FetchTournaments':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tournaments: $krisajenkins$remotedata$RemoteData$Loading}),
					$author$project$ListTournaments$fetchTournaments(dateRange));
			case 'TournamentsReceived':
				var response = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$NewTournament$TournamentCreationResponse = function (id) {
	return {id: id};
};
var $author$project$NewTournament$creationDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$NewTournament$TournamentCreationResponse,
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string));
var $author$project$NewTournament$reqEncoder = function (req) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'date',
				$elm$json$Json$Encode$string(req.date)),
				_Utils_Tuple2(
				'tournament_type',
				$elm$json$Json$Encode$string(req.category)),
				_Utils_Tuple2(
				'name',
		...
		switch (msg.$) {
			case 'StoreCategory':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tournamentRequest: updateCategory}),
					$elm$core$Platform$Cmd$none);
			case 'StoreDate':
				var date = msg.a;
				var req = model.tournamentRequest;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tournamentRequest: updateDate}),
					$elm$core$Platform$Cmd$none);
			case 'StoreName':
				var name = msg.a;
				var oldTourney = model.tournamentRequest;
				var updateName = _Utils_update(
					oldTourney,
					{name: name});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tournamentRequest: updateName}),
					$elm$core$Platform$Cmd$none);
			case 'StoreTshURL':
				var turl = msg.a;
				var oldTourney = model.tournamentRequest;
				var updateUrl = _Utils_update(
					oldTourney,
					{tshURL: turl});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tournamentRequest: updateUrl}),
					$elm$core$Platform$Cmd$none);
			case 'Submit':
				return _Utils_Tuple2(
					model,
					...
					if (_v0.b.$ === 'TournamentListPage') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$TournamentListPage(updatedPageModel)
								}),
					...
					if (_v0.b.$ === 'StandingsPage') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$StandingsPage(updatedPageModel)
								}),
					...
					if (_v0.b.$ === 'NewTournamentPage') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$NewTournamentPage(updatedPageModel)
								}),
...
var $author$project$ListTournaments$viewDeleteError = function (maybeError) {
	if (maybeError.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Couldn\'t delete tournament at this time.')
						])),
...
var $author$project$ListTournaments$viewTableHeader = A2(
	$elm$html$Html$tr,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$ListTournaments$DeleteTournament = function (a) {
	return {$: 'DeleteTournament', a: a};
};
var $elm$html$Html$td = _VirtualDom_node('td');
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $author$project$ListTournaments$viewTournament = function (tournament) {
	return A2(
		$elm$html$Html$tr,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(tournament.date)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(tournament.category)
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$ListTournaments$DeleteTournament(tournament.id))
							]),
						_List_fromArray(
							[
...
var $author$project$ListTournaments$viewTournamentError = function (errorMsg) {
	var errorHeading = 'Couldn\'t fetch tournaments at this time.';
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$ListTournaments$viewTournaments = function (tournaments) {
	switch (tournaments.$) {
		case 'NotAsked':
			return $elm$html$Html$text('');
		case 'Loading':
		...
		case 'Success':
			var actualTournaments = tournaments.a;
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Tournaments')
							])),
						A2(
						$elm$html$Html$table,
						_List_fromArray(
						...
						A2(
							$elm$core$List$cons,
							$author$project$ListTournaments$viewTableHeader,
							A2($elm$core$List$map, $author$project$ListTournaments$viewTournament, actualTournaments)))
					]));
		default:
			var httpError = tournaments.a;
			return $author$project$ListTournaments$viewTournamentError(
				$author$project$Errors$buildErrorMessage(httpError));
	}
};
var $author$project$ListTournaments$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$author$project$ListTournaments$viewTournaments(model.tournaments),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick(params.onclick),
								$elm$html$Html$Attributes$type_('button')
							]),
						_List_fromArray(
							[
...
var $author$project$BulmaForm$optionfn = function (opt) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(opt.display)
			]));
};
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$BulmaForm$selectInput = function (params) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput(params.onchange)
									]),
...
var $author$project$NewTournament$newTournamentForm = A2(
	$elm$html$Html$form,
	_List_Nil,
	_List_fromArray(
		[
			$author$project$BulmaForm$textInput(
			{label: 'Name', oninput: $author$project$NewTournament$StoreName, placeholder: 'My tournament', type_: 'text'}),
			$author$project$BulmaForm$selectInput(
			{
				label: 'Category',
				onchange: $author$project$NewTournament$StoreCategory,
				options: _List_fromArray(
					[
						A2($author$project$BulmaForm$Option, 'MGILeague-Div1', 'MGI League Div 1'),
						A2($author$project$BulmaForm$Option, 'MGILeague-Div2', 'MGI League Div 2'),
						A2($author$project$BulmaForm$Option, 'Masters', 'Masters'),
						A2($author$project$BulmaForm$Option, 'Open', 'Open'),
						A2($author$project$BulmaForm$Option, 'Intermediate', 'Intermediate')
					])
			}),
			$author$project$BulmaForm$textInput(
			{label: 'Date', oninput: $author$project$NewTournament$StoreDate, placeholder: '', type_: 'date'}),
			$author$project$BulmaForm$textInput(
			{label: 'TSH Standings URL', oninput: $author$project$NewTournament$StoreTshURL, placeholder: 'https://tsh.com/14-a.html', type_: 'text'}),
			$author$project$BulmaForm$buttonInput(
			{label: 'Submit', onclick: $author$project$NewTournament$Submit})
		]));
var $author$project$NewTournament$viewError = function (maybeError) {
	if (maybeError.$ === 'Just') {
		var error = maybeError.a;
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Couldn\'t create a tournament at this time.')
						])),
					$elm$html$Html$text('Error: ' + error)
				]));
	} else {
...
var $author$project$NewTournament$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$NewTournament$newTournamentForm,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(standing.rank))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(standing.points))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(standing.wins))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(standing.spread))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(standing.games))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(standing.tournamentsPlayed))
					]))
			]));
};
var $author$project$Standings$viewStandingsError = function (errorMsg) {
	var errorHeading = 'Couldn\'t fetch standings at this time.';
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Standings$viewTableHeader = A2(
	$elm$html$Html$tr,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$title('Position')
						]),
					_List_fromArray(
						[
...
var $author$project$Standings$viewStandings = function (standings) {
	switch (standings.$) {
		case 'NotAsked':
			return $elm$html$Html$text('');
		case 'Loading':
		...
		case 'Success':
			var actualStandings = standings.a;
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						A2(
							$elm$core$List$cons,
							$author$project$Standings$viewTableHeader,
							A2($elm$core$List$map, $author$project$Standings$viewStanding, actualStandings)))
					]));
		default:
			var httpError = standings.a;
			return $author$project$Standings$viewStandingsError(
				$author$project$Errors$buildErrorMessage(httpError));
	}
};
var $author$project$Standings$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$currentView = function (model) {
	...
	switch (_v0.$) {
		...
		case 'TournamentListPage':
			var pageModel = _v0.a;
			return A2(
				$elm$html$Html$map,
				$author$project$Main$ListPageMsg,
				$author$project$ListTournaments$view(pageModel));
		case 'StandingsPage':
			var pageModel = _v0.a;
			return A2(
				$elm$html$Html$map,
